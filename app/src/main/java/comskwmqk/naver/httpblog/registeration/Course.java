...
public class Course {
    ...
    public Course(int courseID, String courseUniversity, int courseYear, String courseTerm, String courseArea, String courseMajor, String courseGrade, String courseTitle, double courseCredit, int courseDivide, int coursePersonnel, String courseProfessor, String courseTime, String courseRoom) {
        this.courseID = courseID;
        this.courseUniversity = courseUniversity;
        this.courseYear = courseYear;
        this.courseTerm = courseTerm;
    ...
    public Course(int courseID, String courseTitle, int courseDivide, String courseGrade, int coursePersonnel, int courseRival,double courseCredit) {
        this.courseID = courseID;
        this.courseTitle = courseTitle;
        this.courseDivide = courseDivide;
        this.courseGrade = courseGrade;
    ...
    public Course(int courseID, String courseGrade, String courseTitle, double courseCredit, int courseDivide, int coursePersonnel, String courseProfessor, String courseTime) {
        this.courseID = courseID;
        this.courseGrade = courseGrade;
        this.courseTitle = courseTitle;
        this.courseCredit = courseCredit;
